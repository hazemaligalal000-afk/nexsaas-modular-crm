...
// Seed Leads (FAANG style)
$leads = [
    [201, 'Sundar', 'Pichai', 'Alphabet', 'sundar@google.com', '+1-555-0101', 'Hot'],
...
foreach ($leads as $l) {
    ...
    $sql = "REPLACE INTO vtiger_leaddetails (leadid, organization_id, firstname, lastname, company, email, phone, leadstatus) 
            VALUES (?, 1, ?, ?, ?, ?, ?, ?)";
